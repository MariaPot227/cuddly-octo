    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 5, 4, 43);
    			attr_dev(header, "class", "svelte-np3sfa");
    			add_location(header, file$2, 4, 0, 29);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 13, 8, 258);
    			attr_dev(p0, "class", "svelte-14d60ui");
    			add_location(p0, file$1, 14, 8, 287);
    			attr_dev(header, "class", "svelte-14d60ui");
    			add_location(header, file$1, 11, 4, 214);
    			...
    			add_location(img, file$1, 17, 8, 353);
    			attr_dev(div0, "class", "image svelte-14d60ui");
    			add_location(div0, file$1, 16, 4, 324);
    			attr_dev(p1, "class", "svelte-14d60ui");
    			add_location(p1, file$1, 20, 8, 438);
    			attr_dev(div1, "class", "content svelte-14d60ui");
    			add_location(div1, file$1, 19, 4, 407);
    			attr_dev(a, "href", a_href_value = "mainto:" + /*email*/ ctx[5]);
    			add_location(a, file$1, 23, 8, 494);
    			add_location(button0, file$1, 24, 8, 540);
    			add_location(button1, file$1, 25, 8, 579);
    			attr_dev(footer, "class", "svelte-14d60ui");
    			add_location(footer, file$1, 22, 4, 476);
    			attr_dev(article, "class", "svelte-14d60ui");
    			add_location(article, file$1, 10, 0, 199);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(section, "class", "meetups svelte-1glyut0");
    			add_location(section, file, 32, 0, 1114);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
